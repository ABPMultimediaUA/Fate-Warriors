...
Consumible_Vida_Infinita::Consumible_Vida_Infinita(short _id, float _i_x, float _i_y, float _i_z) : Consumible_Power_Up(_id,_i_x, _i_y, _i_z), _reloj(Time::Instance()){
