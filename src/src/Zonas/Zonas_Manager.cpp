...
//	_zonas[0] = new Zona(5*mult, 0*mult, 37*mult,20,20, Enum_Equipo_A);
	...
	_zonas[2]  = new Zona_Coliseo(10.5*mult, 0*mult, 34.5*mult, (15*mult)/2, (15*mult)/2, 1, 3, 1, 3, 11);		//Zona 7
	...
	_zonas[5]  = new Zona_Coliseo(34.5*mult, 0*mult, 74*mult, (25*mult)/2, (20*mult)/2, 2, 1, 1, 4, 6);			// Zona 16
	
	_zonas[6]  = new Zona_Final(72*mult, 0*mult, 42*mult,(25*mult)/2,(30*mult)/2, 3, 2, 1, 8);						// Zona 32

	_zonas[7]   = new Zona_Coliseo(73.5*mult, 0*mult, 99*mult, (15*mult)/2, (20*mult)/2, 3, 2, 0, 2, 5);			// Zona 28

	_zonas[8]	= new Zona_Coliseo(61.5*mult, 0*mult, 77.5*mult, (15*mult)/2, (15*mult)/2, 2, 2, 1, 7, 5);			// Zona 26
