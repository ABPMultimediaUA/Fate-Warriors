...
// CAMBIAR EL PARAMETRO DE _TODAS_LAS_ZONAS
	_puertas_pincho[3] = new Puerta_Pincho(0,14.5*mult,0,71*mult, 0, _todas_las_zonas[0], _todas_las_zonas[1],15);	//Entre la sala 10 y 16
	_interruptores[6] = new Interruptor(0,17.4*mult,0,63.8*mult,100, _puertas_pincho[3],false,false, 500);
	_interruptores[7] = new Interruptor(0,22.2*mult,0,69.5*mult,0, _puertas_pincho[3],false,false, 500);

//	_todas_las_zonas[3]->set_interruptor_asociado(_interruptores[6]); //10
//	_todas_las_zonas[5]->set_interruptor_asociado(_interruptores[7]); //16	


	_puertas_pincho[4] = new Puerta_Pincho(0,41.5*mult,0,90.5*mult, 0, _todas_las_zonas[0], _todas_las_zonas[1],21);	//Entre la sala 22 y 16
...
//	_todas_las_zonas[5]->set_interruptor_asociado(_interruptores[8]); //16
//	_todas_las_zonas[4]->set_interruptor_asociado(_interruptores[9]); //22

	_puertas_pincho[5] = new Puerta_Pincho(1,18*mult,0*mult, 31.5*mult, 90, _todas_las_zonas[0], _todas_las_zonas[1],21);	//Entre la sala 3 y 7
	...
	_todas_las_zonas[1]->set_interruptor_asociado(_interruptores[10]); //3
	_todas_las_zonas[2]->set_interruptor_asociado(_interruptores[11]); //7
